...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <Button variant="contained" sx={{backgroundColor: '#A1DE9A', '&:hover': {backgroundColor: '#679162'}}} onClick={() => handleEditar(row.idTarefa)}><EditIcon fontSize="small" /></Button>            
                      </TableCell>
                      <TableCell align="center">
                        <Button variant="contained" sx={{backgroundColor: '#D86666', '&:hover': {backgroundColor: '#c62828'}}} onClick={() => handleDeletar(row.idTarefa)}><DeleteIcon fontSize="small" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>
        ...
        <CardActions>
            <Button size="small" variant="contained" sx={{backgroundColor: '#FF5733', '&:hover': {backgroundColor: '#A92306'} }}onClick={handleOpen}>Criar Tarefa</Button>
